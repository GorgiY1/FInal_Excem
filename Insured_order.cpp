...
Insured_order::Insured_order(Date order_date, Time order_time, string description, string name_company, float money_amount, Client cliet) :Ordinary_order(order_date, order_time, description, cliet)
{
	if (name_company != "")
	{
