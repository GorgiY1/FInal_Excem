...
Express_Order::Express_Order(Date order_date, Time order_time, string description,string courier, int days_to_deliver, Client client):Ordinary_order(order_date, order_time,description, client)
{
